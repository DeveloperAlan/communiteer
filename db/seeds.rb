...
# Does not work!
#brad_pitt = Volunteer.create(first_name: 'Brad', last_name: 'Pitt', email: 'brad.pitt@gmail.com', image: 'http://img.timeinc.net/time/time100/2007/images/brad_pitt.jpg', is_coordinator: false)
# volunteers = [
